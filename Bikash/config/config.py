...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "༺ Aria x Music ༻")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5230338052").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/KhuniVillan/AriaMusic")
...
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/c2f110353910f1a166016.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://graph.org/file/185978d3d6c2beff97073.jpg")
...
if PING_IMG_URL:
    if PING_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://graph.org/file/185978d3d6c2beff97073.jpg"

if START_IMG_URL:
    if START_IMG_URL != "resources/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://graph.org/file/c2f110353910f1a166016.jpg"
